...
from oneHourStockPointFile10.stocks import stock_symbols as symbols
...
def get_price(symbol, proxy, tries=0):
    price_date = datetime.utcnow().strftime("%Y-%m-%d %H:00:00")
...
def get_date_name():
    ...
    return date_obj.strftime("%Y%m%d%H0000_10")
